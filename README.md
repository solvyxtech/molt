...
Frontier models narrow this gap rather than closing it, and a rarer false completion is arguably more dangerous, because rarity is what stops you checking. See [docs/why.md](docs/why.md), which includes a table of confident wrong claims that came up while building molt, and how each was caught.
