...
export const COMMANDS: Command[] = [
  ...
  },
  {
    name: "/interview",
    args: "<task>",
    summary: "ask before work; seal into the bar and criteria",
    aliases: ["spec"],
  },
  ...
  { name: "/init", summary: "write a starter .molt/done.yml" },
  {
    name: "/commit",
    args: "[on|off]",
    summary: "commit automatically when the bar is met",
    aliases: ["autocommit", "git", "keep"],
  },
  {
    name: "/revert",
    args: "[on|off]",
    summary: "put the tree back when the bar is not met",
    aliases: ["discard", "reset", "rollback"],
  },
  {
    name: "/undo",
  ...
  {
    name: "/map",
    args: "[refresh|<tokens>|off]",
    summary: "the repository map the model starts with",
    aliases: ["repo", "tree", "symbols"],
  },
  {
    name: "/read",
    args: "<path>",
    summary: "pin a file as readable but never writable",
    aliases: ["readonly", "pin", "protect", "freeze"],
  },
  {
    name: "/attempts",
    args: "<n>",
    summary: "completion attempts before a turn reports failure",
    aliases: ["retries", "tries"],
  },
  {
    name: "/autoshed",
    args: "<tokens|off>",
    summary: "compact history automatically past this size",
    aliases: ["compact", "threshold"],
  },
  {
    name: "/receipts",
    args: "[show <n|file>|last]",
    summary: "list attempts, or show a receipt body",
    aliases: ["evidence", "proof"],
  },
  {
    name: "/verify",
    summary: "recompute every hash chain in this project",
    aliases: ["integrity", "ledger"],
  },
  {
    name: "/spine",
    args: "[on|off]",
    summary: "pin the bar checks above the prompt",
    aliases: ["barstrip", "checks"],
  },
